...
class AirWaterHeatPump:
    ...
    def nspek_heatpump_calculation(self, building, power_reduction = 0, cop_reduction = 0, defrosting_min = -5, defrosting_max = 5):
        ...
        heating_demand_array = building.results.energy.spaceheating + building.results.energy.dhw
        ...
        building.results.energy.air_water_heat_pump_compressor = self.compressor_array
        building.results.energy.air_water_heat_pump_extracted_from_air = self.from_air_array
        building.results.energy.air_water_heat_pump_peak = self.peak_array
        building.results.energy.air_water_heat_pump_electricity = self.compressor_array + self.peak_array
        #--
        building.results.investment.air_water_heat_pump_size = self.P_NOMINAL
        building.results.investment_lifetime.air_water_heat_pump_size = 15
        building.results.reinvestment_cost.air_water_heat_pump_size = (self.P_NOMINAL * 12000 * 0.6)
        building.results.investment_cost.air_water_heat_pump_size = self.P_NOMINAL * 12000
